...
from database import Base, uniq_str_an, content_an
...
class Profile(Base):
    ...
    # interests: Mapped[array_or_none_an] #  sqllite не работает
...
class Post(Base):
    ...
    # photos_url: Mapped[array_or_none_an] #  sqllite не работает
    main_photo_url: Mapped[MutableList[str]] = mapped_column(MutableList.as_mutable(JSON))
